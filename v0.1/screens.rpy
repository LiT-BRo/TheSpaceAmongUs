...
screen about():
    ...
    use game_menu(_("Credits"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("{size=+25}[config.name!t]{/size}")
            label "{size=+10}Version [config.version!t]{/size}\n"



            ## gui.about is usually set in options.rpy.
            if gui.about:
                text _("{size=-5}Made by the students of {a=https://www.shalomhills.com/}Shalom Hills International School{/a} (2021-22):{/size}")
                label "[gui.about!t]\n"
